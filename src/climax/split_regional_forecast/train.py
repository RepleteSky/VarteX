...
from climax.split_regional_forecast.datamodule import SplitRegionalForecastDataModule
from climax.split_regional_forecast.module import SplitRegionalForecastModule
...
def main():
    ...
    cli = LightningCLI(
        model_class=SplitRegionalForecastModule,
        datamodule_class=SplitRegionalForecastDataModule,
